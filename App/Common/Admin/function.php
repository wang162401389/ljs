...
function getMemberInfoList($search=array(),$size=''){
	...
	$field = "m.id,m.id as uid,m.user_phone,m.user_name,mbank.uid as mbank_id,mi.uid as mi_id,mci.uid as mci_id,mhi.uid as mhi_id,mdpi.uid as mdpi_id,mei.uid as mei_id,mfi.uid as mfi_id";

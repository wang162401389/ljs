...
class TenderListViewModel extends ViewModel
{
    public $viewFields = array(
        'BorrowInvestor'=>array('id','status','borrow_id','investor_uid','borrow_uid','investor_capital','investor_interest','receive_capital','receive_interest','substitute_money','expired_money','invest_fee','paid_fee','add_time'=>'invest_time','deadline','is_auto','reward_money','debt_id','_type'=>'LEFT'),
        ...
        'Members'=>array('user_name'=>'borrow_user','user_phone'=>'userphone','credits','_on'=>'Members.id=Borrow.borrow_uid','_type'=>'LEFT'),
         ...
         'InvestorDetail'=>array('status','repayment_time'=>'repaytime','deadline'=>'times','expired_money'=>'myexpired_money','jiaxi_money','jiaxi_rate','_on'=>'InvestorDetail.invest_id=BorrowInvestor.id'),
